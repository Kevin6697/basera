...
<body class="htlfndr-404-page">

<div class="htlfndr-wrapper">
	<header>
		<div class="container text-center">
			<a class="htlfndr-logo" href="index.php">
	...
	<div class="container">
		...
		<main id="htlfndr-main-content" class="htlfndr-404-content text-center" role="main">	
			<p class="htlfndr-404-title">The page you were looking for could not be found</p>
			<p class="htlfndr-404">404</p>
			<a href="index.php" class="htlfndr-404-btn"><i class="fa fa-home"></i>Go to Homepage</a>
	...
	<footer class="htlfndr-footer">
		<div class="container">
			<div class="navbar-collapse fail-page text-center" id="htlfndr-main-nav">
