<?php
    ...
    //lines and table header
        ...
        $this->Text(29,55,'Customer Name',1,0,'C');
    ...
    $this->SetFont('Arial','',12);
    $result=$dbConnection->allCustomers();    
    while($rows= (mysqli_fetch_assoc($result)))
        {
            ...
            $mobile=$rows['CustNumber'];
            $registrationDateTime=$rows['CustomerRegistrationDate'];
        ...
        $this->Text(80, 45, 'Customers Report', 1, 0, 'C');
