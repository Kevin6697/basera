<?php
    ...
    //lines and table header
        ...
        $this->Text(159,55,'Cancelled',1,0,'C');
        $this->Text(181,55,'Paid Amt.',1,0,'C');
    ...
    {
        if($rows['ConfirmationStatus']==4 || $rows['ConfirmationStatus']==5)
        {
            $i=$i+1;
            $y=$y+6;
            //$toatalHousePrice=0;
            ...
            $confirmation=$rows['ConfirmationStatus'];
            ...
            {
                $this->SetXY (159,$y);
                $this->Write(7,"By Owner");
            }
            elseif($confirmation==5)
            {
                $this->SetXY (159,$y);
                $this->Write(7,"By Customer");
            }
                $this->SetXY (180,$y);
        ...
        $this->Text(80, 45, 'Cancelled Bookings Report', 1, 0, 'C');
