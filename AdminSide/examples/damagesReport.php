<?php
    ...
    //lines and table header
        ...
        $this->Text(119,55,'City',1,0,'C');
        $this->Text(138,55,'Date',1,0,'C');
        $this->Text(159,55,'Item Name.',1,0,'C');
    ...
    $this->Line(117,50,117,254,0);//house name
       $this->Line(137,50,137,254,0);//city
       $this->Line(157,50,157,254,0);//check out

        $this->Line(179,50,179,260,0);//item
        $this->Line(200,50,200,260,0);// price
    ...
    $grandTotal=0;
    $this->SetFont('Arial','',12);
    $result=$dbConnection->allDamages();    
    while($rows= (mysqli_fetch_assoc($result)))
        ...
        $this->Text(80, 45, 'Damages Report', 1, 0, 'C');
